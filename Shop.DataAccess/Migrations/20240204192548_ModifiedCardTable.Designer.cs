...
namespace Shop.DataAccess.Migrations
{
    ...
    [Migration("20240204192548_ModifiedCardTable")]
    partial class ModifiedCardTable
    {
            ...
            modelBuilder.Entity("Shop.Core.Entities.Card", b =>
                {
                    ...
                    b.HasIndex("CardNumber", "CvcCode")
                        .IsUnique()
                        .HasFilter("[CardNumber] IS NOT NULL AND [CvcCode] IS NOT NULL");
            ...
            modelBuilder.Entity("Shop.Core.Entities.Wallet", b =>
                {
                    b.HasOne("Shop.Core.Entities.Card", "Card")
                        .WithOne("Wallet")
                        .HasForeignKey("Shop.Core.Entities.Wallet", "CardId");
